             ...
             <div class="dropdown-menu p-0" aria-labelledby="appsDropdown">
                ...
                <div class="row g-0 p-1">
                   <div class="col-3 text-center">
                      <a href="https://www.nobleui.com/laravel/template/demo1/apps/chat" class="dropdown-item d-flex flex-column align-items-center justify-content-center wd-70 ht-70">
                         <i data-feather="message-square" class="icon-lg mb-1"></i>
                         <p class="tx-12">Chat</p>
                      </a>
                   </div>
                   <div class="col-3 text-center">
                      <a href="https://www.nobleui.com/laravel/template/demo1/apps/calendar" class="dropdown-item d-flex flex-column align-items-center justify-content-center wd-70 ht-70">
                         <i data-feather="calendar" class="icon-lg mb-1"></i>
                         <p class="tx-12">Calendar</p>
                      </a>
                   </div>
                   <div class="col-3 text-center">
                      <a href="https://www.nobleui.com/laravel/template/demo1/email/inbox" class="dropdown-item d-flex flex-column align-items-center justify-content-center wd-70 ht-70">
                         <i data-feather="mail" class="icon-lg mb-1"></i>
                         <p class="tx-12">Email</p>
                      </a>
                   </div>
                   <div class="col-3 text-center">
                      <a href="https://www.nobleui.com/laravel/template/demo1/general/profile" class="dropdown-item d-flex flex-column align-items-center justify-content-center wd-70 ht-70">
